...
Copy `SKILL.md` and `references/` into your agent's `nichemaxx` skill folder. Private taste archives are optional, stay local and are not included. See the context guide for the optional local index.

The former mandatory full-brain read and fixed editing rules are retired. Earlier reference material remains in Git history; it is not the current skill's authority. Exact reference details must be verified.
